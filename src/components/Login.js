        ...
        >
            ...
            <div className="col-md-6 text-primary my-auto text-center">
                ...
                <form className="container">
                    ...
                    <div className="mb-3 w-50 mx-auto text-start container row">
                        <div className="col-md-6">
                            <input className="me-3" type="checkbox" id="remember" name="remember"/>
                            <label className="h5" htmlFor="remember">Remember Password</label>
                        </div>
                        <div className="col-md-6">
                            <a className="link-underline link-offset-3 link-underline-opacity-0 link-underline-opacity-100-hover float-end h5">
                                Forgot Password
                            </a>
                        </div>
                    </div>
